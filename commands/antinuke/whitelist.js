...
module.exports = {
    name: 'whitelist',
    usage: 'Whitelist a user from anti-nuke',
    aliases: ['wl'],
    category: 'security',
    premium: false,
    run: async (client, message, args) => {
        ...
        if (!antinuke) {
            const dissable = client.util.embed().setColor(client.color)
                .setDescription(` ** ${message.guild.name} security settings <a:${client.user.username}_antinuke_cmd:1180431827438153821>
Ohh NO! looks like your server doesn't enabled security

Current Status : ${client.emoji.disable}
                ...
                msg = await message.channel.send({
                    embeds: [
                        client.util.embed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `${client.emoji.disable} : **Ban**\n${client.emoji.disable} : **Kick**\n${client.emoji.disable} : **Prune**\n${client.emoji.disable} : **Bot Add**\n${client.emoji.disable} : **Server Update\n${client.emoji.disable} : Member Role Update**\n${client.emoji.disable} : **Channel Create**\n${client.emoji.disable} :** Channel Delete**\n${client.emoji.disable} : **Channel Update**\n${client.emoji.disable} : **Role Create**\n${client.emoji.disable} : **Role Delete**\n${client.emoji.disable} : **Role Update**\n${client.emoji.disable} : **Mention** @everyone\n${client.emoji.disable} : **Webhook Management**\n${client.emoji.disable} : **Emojis & Stickers Management**`
                            )
                            .addFields(
                                {
                                    name: `**Executor**`,
                ...
                msg = await message.channel.send({
                    embeds: [
                        client.util.embed()
                            ...
                            .setColor(client.color)
                            .setDescription(
                                `${data.ban ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Ban**\n${data.kick ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Kick**\n${data.prune ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Prune**\n${data.botadd ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Bot Add**\n${data.serverup ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Server Update\n${data.memup ? `${client.emoji.enable}` : `${client.emoji.disable}`}: Member Role Update**\n${data.chcr ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Channel Create**\n${data.chdl ? `${client.emoji.enable}` : `${client.emoji.disable}`}: ** Channel Delete**\n${data.chup ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Channel Update**\n${data.rlcr ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Role Create**\n${data.rldl ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Role Delete**\n${data.rlup ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Role Update**\n${data.meneve ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Mention** @everyone\n${data.mngweb ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Webhook Management**\n${data.mngstemo ? `${client.emoji.enable}` : `${client.emoji.disable}`}: **Emojis & Stickers Management**`
                            )
                            .addFields(
                                {
                                    name: `**Executor**`,
