...
//const ${client.user.username}Pagination = require('./${client.user.username}Pagination'); // Assuming your pagination function is in this file

module.exports = {
    name: 'list',
    usage: 'Manage list settings',
    aliases: ['l'],
    category: 'mod',
    premium: false,
