...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const embed = client.util.embed()
            ...
            .setFooter({ text : `Developed with 💖 By ${client.user.username} Team`})
        ...
        switch (type) {
            case `activate`:
                ...
                if (count > 0) {
                    ...
                    await message.guild.members.me.setNickname("${client.user.username} Beast").catch((err) => {})
                    return message.reply({
                        embeds: [
                            embed.setDescription(
