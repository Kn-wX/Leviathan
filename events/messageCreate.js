...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = `https://discord.gg/W2bgPVMnEg`
            ...
            const row = new ActionRowBuilder().addComponents(
                ...
                new ButtonBuilder()
                    .setLabel(`Support`)
                    .setStyle(ButtonStyle.Link)
                    .setURL(`https://discord.gg/W2bgPVMnEg`)
            )
            ...
            let user = client.users.cache.get(`839014541157203979`) ? client.users.cache.get(`839014541157203979`) : await client.users.fetch(`839014541157203979`).catch((err) => { })
